---
title: "Week 03 Assignment 02_datasets Revisited"
author: "Josh Pickel"
...
output:
  pdf_document:
    ...
    template: ./../latex-templates/homework.1.tex
  html_document:
    df_print: paged
...
## Plot (See next page for plot)
```{r, warning = FALSE,fig.cap = 'Plot From Plotting IRIS Data',fig.dim = c(6,6),fig.align = 'center'}
library(datasets)
...
## Get Actor Data And Compare Boxplots
```{r, Will Denzel, message = FALSE, fig.cap = 'Denzel and Will Raw Millions'}
source_url(paste0(github.path,"master/functions/functions-imdb.R"))
...
```{r, adjusting Denzel and Will, message = FALSE, warning = FALSE}
# Get inflation data
...
```{r, Will vs Denzel,fig.cap = 'Boxplot Comparing Will vs Denzel Using Adjusted Millions', fig.dim = c(5,5), fig.align = 'center'} 
...
```{r, Will vs Denzel Years, fig.cap = 'Boxplot Showing Will vs. Denzel Years', fig.dim = c(5,5), fig.align = 'center'}
...
```{r, Will vs Denzel Runtime, fig.cap = 'Boxplot Comparing Will vs Denzel Movie Runtime', fig.dim = c(5,5), fig.align  = 'center'}
